...
export const options = {
  ...
  thresholds: {
    ...
    "http_req_duration{staticAsset:yes}": ["p(99)<30"],
...
export default function main() {
  const response = http.get("https://localhost:8080/metrics/ui");
  ...
  // group("Static Assets", function staticAssets() {
