...
import {METHODS} from "./router.mjs";
...
export class Cors extends Middleware {
  ...
  async render({req, res}) {
    ...
    if (this.options.origin) {
      // console.debug('Cors Origin:', this.options.origin, req.headers.origin || req.headers[HTTP2_HEADER_HOST]);
      if (
        ...
        req.headers.origin || req.headers[HTTP2_HEADER_HOST];
        res.headers[HTTP2_HEADER_VARY] = "Origin";
        ...
        res.headers[
          HTTP2_HEADER_ACCESS_CONTROL_ALLOW_ORIGIN
        ] = "https://NoMatchingOrigin.invalid";
      }
    }
