...
import {deepmerge, get, set} from "../util/index.mjs";
import {Middleware, Router, Route} from "./index.mjs";
...
export class OpenApi extends Router {
  ...
  routeToOpenapi({method, path, data: {openapi = {}}}, realPath) {
    const {operationId = pathToId(path, method), summary = path, description, schema = {}, ...passthrough} =
            openapi;
