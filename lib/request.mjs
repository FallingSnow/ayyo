...
import {collectStream} from "./util/index.mjs";
import {parse as formDataParse} from "./formdata-parser.mjs";
...
export default class Request {
  ...
  async parseBody(stream) {
    const content = isStream(stream) ? await collectStream(stream) : stream;
