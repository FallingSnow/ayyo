...
const {HTTP2_HEADER_PATH, HTTP2_HEADER_CONTENT_TYPE, HTTP2_HEADER_HOST} = http2.constants;

export default class Request {
    constructor(headers, flags) {
        this.headers = headers;
        this.flags = flags;
        const parsedUrl = new URL(headers[HTTP2_HEADER_PATH], headers[HTTP2_HEADER_HOST]);
        this.url = parsedUrl;
